    ...
    <Fragment>  
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-4 mt-5">
            <div className="card text-center">
              ...
              <div className="card-footer text-muted">
                <div className="row">
                  <div className="col">
                    <a href="https://github.com/jomullen11/Teams-Sidebar" target="_blank" rel="noopener noreferrer">View on GitHub<i className="devicon-github-plain"></i></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mt-5">
            <div className="card text-center">
            <a href="https://github.com/jomullen11/Search1" target="_blank" rel="noopener noreferrer"><img className="card-img-top cardImage" src="https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-9/55845492_10156215084426989_2065642655332696064_o.jpg?_nc_cat=110&_nc_ht=scontent-sjc3-1.xx&oh=944f3277994bf230174a328fea8785a3&oe=5D0AC0B2" alt="Search Bar"/></a>
              <div className="card-body" id="card">
              ...
              <div className="card-footer text-muted">
                <div className="row">
                  <div className="col">
                    <a href="https://github.com/jomullen11/Search1" target="_blank" rel="noopener noreferrer">View on GitHub<i className="devicon-github-plain"></i></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mt-5">
            <div className="card text-center">
              <a href="https://github.com/jomullen11/Name-change" target="_blank" rel="noopener noreferrer"><img className="card-img-top cardImage" src="https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-9/56350740_10156215084306989_5788258318795407360_n.jpg?_nc_cat=111&_nc_ht=scontent-sjc3-1.xx&oh=ab77581d62580dbc31b83525936905f7&oe=5D101439" alt="Name Tag" /></a>
              <div className="card-body" id="card">
              ...
              <div className="card-footer text-muted">
                <div className="row">
                  <div className="col">
                    <a href="https://github.com/jomullen11/Name-change" target="_blank" rel="noopener noreferrer">View on GitHub<i className="devicon-github-plain"></i></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mt-5">
            <div className="card text-center">
              <a href="https://github.com/jomullen11/Tic-Tactorial" target="_blank" rel="noopener noreferrer"><img className="card-img-top cardImage" src="https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-9/55924213_10156215084476989_8145686728502411264_n.jpg?_nc_cat=111&_nc_ht=scontent-sjc3-1.xx&oh=c85ad4160f8182c4853cf40a4d0cf14e&oe=5D4B3BC9" alt="Tic Tac Toe" /></a>
              <div className="card-body" id="card">
              ...
              <div className="card-footer text-muted">
                <div className="row">
                  <div className="col">
                    <a href="https://github.com/jomullen11/Tic-Tactorial" target="_blank" rel="noopener noreferrer">View on GitHub<i className="devicon-github-plain"></i></a>
                  </div>
                </div>
              </div>
            </div>
